"""Agent #15 -- Multi-System Clearance (docs/agent_requirements.md #15 / blueprint1.md #15).
...
node (not a new top-level graph node) -- see agents/hub/supervisor.py.

Run (from repo root, with agents/.venv active):
    python -m agents.spokes.multi_system_clearance <case_id>
    python -m agents.spokes.multi_system_clearance --self-check
"""
