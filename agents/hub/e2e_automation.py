"""Agent #24 -- End-to-End Exit Automation (Capstone) (docs/agent_requirements.md #24 /
agents_spec.md #24).
...
Run (from repo root, with agents/.venv active, PYTHONIOENCODING=utf-8 on Windows):
    ...
    python -m agents.hub.e2e_automation <case_id> --reject
"""
...
from .. import service
from ..analytics import sla_escalation
