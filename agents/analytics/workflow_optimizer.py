"""Agent #17 -- Exit Workflow Optimizer (docs/agent_requirements.md #17 / blueprint1.md #17).
...
Run (from repo root, with agents/.venv active):
    ...
    python -m agents.analytics.workflow_optimizer --self-check
"""
...
SYSTEM_PROMPT = load_prompt("analytics/workflow_optimizer_system.md")
