...
function CaseInterviewTab({ exitCase, interviews }) {
  ...
  return <div className="hr-interview-grid">
    <section className="hr-panel hr-interview-summary"><div className="hr-panel-heading"><div><p className="hr-eyebrow">AI analysis</p><h2>Interview summary</h2></div><StatusBadge tone={SENTIMENT_TONE[interview.sentiment] || 'neutral'}>{interview.sentiment ? humanize(interview.sentiment) : 'Analysis pending'}</StatusBadge></div><p>{interview.summary || 'Analysis pending'}</p><div className="hr-interview-recommendation"><strong>Recommendations</strong><p>{interview.recommendations || 'Analysis pending'}</p></div><div className="hr-interview-recommendation"><strong>Rehire reason</strong><p>{interview.rehire_reason || 'Analysis pending'}</p></div></section>
